...
welcome_label.grid(row=10, column=0, columnspan=2, padx=10, pady=10)
...
attendance_frame.grid(row=0, column=25)

spell_5_var = IntVar()
spell_5_on = ttk.Checkbutton(top_frame,
                             text="Spell 5 on/off",
                             variable=spell_5_var)
spell_5_on.grid(row=11, column=0)
